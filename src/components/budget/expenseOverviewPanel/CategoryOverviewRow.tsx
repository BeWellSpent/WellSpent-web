            ...
            <Collapse in={isExpanded} timeout="auto" unmountOnExit>
              <Box sx={{ py: 1, pl: 7 }}>
                {people.map((p) => {
                  ...
                  return (
                    <Box key={p.id.toString()} sx={{ display: 'flex', alignItems: 'center', gap: 2, py: 0.5 }}>
                      {p.color && (
                      ...
                      <Typography
                        variant="body2"
                        sx={{ minWidth: 80, textAlign: 'right', color: isPersonOver ? 'error.main' : (personActual > 0 ? 'success.main' : 'text.disabled') }}
                      >
